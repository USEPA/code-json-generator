...
2. The [daily-deploy.yml](https://github.com/USEPA/code-json-generator/actions/workflows/daily-deploy.yml) generates the code.json file to this repository's [master branch](https://github.com/USEPA/code-json-generator/tree/master). This workflow is disabled.
